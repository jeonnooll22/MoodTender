...
def _imread(path, flags=cv2.IMREAD_COLOR):
    # cv2.imread fails on non-ASCII (e.g. Korean) paths on Windows
...
class InferenceConfig(PrintableConfig):
    ...
    mask_crop: ndarray = field(default_factory=lambda: _imread(make_abs_path('../utils/resources/mask_template.png'), cv2.IMREAD_COLOR))
